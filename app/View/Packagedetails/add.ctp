...
<h1 class="login"><img src="<?php echo STATIC_BPONG?>/img/logclose.png" id="Close" class="right" style="cursor:pointer; padding:4px 0px 0px 0px;"  onclick="self.parent.tb_remove();" />Add new package detail</h1>
<div style="background-color:#FFFFFF">
<?php echo $this->Form->create('Packagedetail',array('name'=>'PackagedetailAddForm','id'=>'PackagedetailAddForm','url'=>'/packagedetails/add/'.$modelName.'/'.$modelID.'/'.$packageID));?>
	<fieldset>
	<div class="error" id="error-message" <?php echo isset($Error)?"":"style='display: none;'" ?>>Error while adding.</div>
	<?php
            echo $this->Form->input('Packagedetail.start_date', array('type'=> 'text', 'style' => 'width:100px;', 'size' => 10 ,'class' => 'date-pick dp-applied', 'readonly' => true));
             echo $this->Form->input('Packagedetail.end_date', array('type'=> 'text', 'style' => 'width:100px;', 'size' => 10 ,'class' => 'date-pick dp-applied', 'readonly' => true));
