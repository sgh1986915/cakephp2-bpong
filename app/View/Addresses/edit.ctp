<h1 class="login"><div class="left">Edit address information</div>
...
function showResponse(responseText)  {
  if (responseText=="Error"){
       ...
       $('#addressInformation').load("/addresses/view/<?php echo $modelName.'/'.$modelID.'/'.$ownerID.$URL ?>",{cache: false},function(){tb_init('a.thickbox, area.thickbox, input.thickbox');});
  		tb_remove();
  }
}

</script>
<?php echo $this->Form->create('Address',array('name'=>'AddressEditForm','id'=>'AddressEditForm','url'=>'/addresses/edit/'.$modelName.'/'.$modelID.'/'.$ownerID.'/'.$addressID.$URL));?>
