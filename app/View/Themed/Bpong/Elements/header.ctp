<!--=== Header v6 ===-->
<div class="header-v6 header-classic-white header-white-transparent header-sticky">
    <!-- Navbar -->
        ...
        <div class="container">
            ...
            <div class="menu-container">
                ...
                <div class="navbar-brand">
                    <a href="index.html">
                        <?php echo $this->Html->image('logo.png', array('id' => 'logo-header')); ?>
                    </a>
                </div>
                <!-- ENd Navbar Brand -->
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="feature_header_v6_classic_white.html">Header v6 Classic White</a></li>
