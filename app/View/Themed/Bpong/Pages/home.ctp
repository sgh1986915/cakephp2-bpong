...
<div class="row magazine-page">
        ...
        <div class="carousel slide carousel-v1 margin-bottom-40" id="myCarousel-1">
            <div class="carousel-inner">
                <div class="item active">
                    <?php echo $this->HTml->image('bar-program-hero.jpg'); ?>
                    <div class="carousel-caption">
                        <p>Bar Program</p>
                    </div>
                </div>
                <div class="item">
                    <?php echo $this->HTml->image('table_black_ad.gif'); ?>
                    <div class="carousel-caption">
                        <p>Table Black Ad</p>
                    </div>
                </div>
                <div class="item">
                    <?php echo $this->HTml->image('table_white_ad.gif'); ?>
                    <div class="carousel-caption">
                        <p>Table White Ad</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="magazine-news-img">
                        <a href="#"><?php echo $this->HTml->image('table_black_ad.gif', array('class' => 'img-responsive')); ?></a>
                ...
                <div class="col-md-6">
                    <div class="magazine-news-img">
                        <a href="#"><?php echo $this->HTml->image('table_white_ad.gif', array('class' => 'img-responsive')); ?></a>
    ...
    <div class="col-md-3">
        ...
        <div class="row margin-bottom-40">
            <div class="magazine-posts col-md-12 col-sm-6 margin-bottom-30">
                ...
                <div class="magazine-posts-img">
                    <a href="#"><?php echo $this->HTml->image('table_black_ad.gif', array('class' => 'img-responsive')); ?></a>
                    <span class="magazine-badge magazine-badge-red">Music</span>
                </div>
            </div>
            <div class="magazine-posts col-md-12 col-sm-6">
                ...
                <div class="magazine-posts-img">
                    <a href="#"><?php echo $this->HTml->image('table_white_ad.gif', array('class' => 'img-responsive')); ?></a>
                    <span class="magazine-badge magazine-badge-green">Fashion</span>
                </div>
            </div>
        </div>
        <!-- End Magazine Posts -->
        ...
        <ul class="list-unstyled blog-photos margin-bottom-35">
            <li></li><a href="#"><?php echo $this->HTml->image('osheas-playing-area.jpg', array('class' => 'hover-effect thumbnail')); ?></a></li>
            <li></li><a href="#"><?php echo $this->HTml->image('osheas-playing-area.jpg', array('class' => 'hover-effect thumbnail')); ?></a></li>
            <li></li><a href="#"><?php echo $this->HTml->image('osheas-playing-area.jpg', array('class' => 'hover-effect thumbnail')); ?></a></li>
        </ul>
        <!-- End Photo Stream -->
