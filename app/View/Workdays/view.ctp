...
<h2><?php echo __('Workday');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Id'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $workday['Workday']['id']; ?>
			&nbsp;
		</dd>
		<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Name'); ?></dt>
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $workday['Workday']['name']; ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Edit Workday'), array('action'=>'edit', $workday['Workday']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Workday'), array('action'=>'delete', $workday['Workday']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $workday['Workday']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Workdays'), array('action'=>'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Workday'), array('action'=>'add')); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($workday['Venue'] as $venue):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
