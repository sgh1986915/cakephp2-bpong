<div class="venueactivities view">
<h2><?php echo __('Venueactivity');?></h2>
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Edit Venueactivity'), array('action'=>'edit', $venueactivity['Venueactivity']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Venueactivity'), array('action'=>'delete', $venueactivity['Venueactivity']['id']), null, sprintf(__('Are you sure you want to delete # %s?'), $venueactivity['Venueactivity']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($venueactivity['Venue'])):?>
	...
	<?php
		$i = 0;
		foreach ($venueactivity['Venue'] as $venue):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
