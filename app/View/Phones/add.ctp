...
<h1 class="login">
  <div class="left">Add new phone</div>
...
<?php echo $this->Form->create('Phone',array('name'=>'PhoneAddForm','id'=>'PhoneAddForm','url'=>'/phones/add/'.$modelName.'/'.$modelID.'/'.$ownerID));?>
