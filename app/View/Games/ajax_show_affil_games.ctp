...
<?php if (empty($games)):?>
 	...
 	<table class="sorter red_table" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	  	<th style='text-align:center;' class='first-red-th'>Game num.</th>
	...
	<?php
	  ...
	  <tr <?php echo $class;?>>
		...
		<td style='text-align:center;'>
			<a href='/nation/beer-pong-teams/team-info/<?php echo $vinner['slug']; ?>/<?php echo $vinner['id']; ?>/<?php echo $game['Game']['event_id'];?>' class='green_link'>
			<?php echo $this->Formater->stringCut($vinner['name'], 30);?></a> 
			<br/><span style='font-weight:normal'>vs</span><br/>
			<a href='/nation/beer-pong-teams/team-info/<?php echo $looser['slug'] ?>/<?php echo $looser['id']; ?>/<?php echo $game['Game']['event_id']; ?>'>
			<?php echo $this->Formater->stringCut($looser['name'], 30);?></a> 
		</td>
