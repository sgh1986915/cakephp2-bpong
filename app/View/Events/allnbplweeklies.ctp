...
<?php echo $this->Form->create('Event',array('id'=>'EventFilter','name'=>'EventFilter','action'=>'allnbplweeklies'));?>
<fieldset>
...
<div class="promocodes" style="margin-top:1px">
    <div style="width:150px; display:inline;">
        <label for="EventFilterShowOnlyPast">Show only past events</label>
        <?php echo $this->Form->input('EventFilter.show_only_past',array('type'=>'checkbox','label'=>false)); ?>
    </div>
</div>
<div class="promocodes" style="margin-top:1px">
    <div style="width:150px; display:inline;">
        <label for="EventFilterHideCompleted">Hide Completed Events</label>
        <?php echo $this->Form->input('EventFilter.hide_completed',array('type'=>'checkbox','label'=>false)); ?>
    </div>
</div>
</fieldset>
