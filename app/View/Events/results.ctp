...
<?php $this->pageTitle = 'Completed Events'; ?>
<?php echo $this->Html->css('eventlist.css'); ?>
<h2 class='hr' style='margin-bottom:0px;'>Completed Events</h2>
<div id="eventsList">
<?php $this->Paginator->options(array('url' => $this->passedArgs)); ?>
	...
	<table class="eventlist sorter" border="0" cellspacing="0" cellpadding="0">
	  <tr class="paginationEvents">
	    ...
	    <th>Stats</th>
	    <th><?php echo $this->Paginator->sort('Votes', 'votes', array('sorter' => true));?></th>
