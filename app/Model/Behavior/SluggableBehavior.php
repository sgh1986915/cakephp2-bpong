<?php 
/* SVN FILE: $Id: sluggable.php 1647 2008-10-25 11:00:11Z vovich $ */
...
class SluggableBehavior extends ModelBehavior
{
    ...
    {
        $default = array('label' => array('title'), 
          'slug' => 'slug', 
          'separator' => '-', 
          'length' => 100, 
          'overwrite' => false, 
            ...
            if (!empty($label)) {
                ...
                if ($this->__settings[$model->alias]['unique']) {
                    ...
                    if (!empty($model->id)) {
                        ...
                        array_push($conditions, $model->alias . '.' . $model->primaryKey . ' != ' . $model->id);
                    }
    ...
    function __slug($string, $settings)
    {
        ...
        //Added by Vovich - clear HTML special chars and ENTITIES
        $string = strip_tags($string);
        $string = eregi_replace("&([A-Za-z0-9]){2,};", "", $string);
