 ...
 * @package cpamf
 * @subpackage filters
 * @version $Id: CakeActions.php 96 2009-07-07 11:16:01Z daniel.verner $
 */
		...
		if ($lpos === false) {
			...
			if($messageType == 'flex.messaging.messages.RemotingMessage')
			{
				...
				if( $classAndPackage == "Amfphp.DiscoveryService" )
				{
					...
					$baseClassPath = ROOT . DS . APP_DIR . DS . "plugins" . DS . "cpamf" . DS . "controllers" . DS;
				}
				...
				$uriclasspath = Inflector::underscore( str_replace('.','/',$classAndPackage) ) . '.php';
