...
class AuthorizeNet {
   ...
   function add_field($field, $value) {
      ...
      $this->fields["$field"] = $value;//urlencode($value);
   ...
   function dump_fields() {
      ...
      $output = "<h3>authorizenet_class->dump_fields() Output:</h3>";
      $output .= "<table width=\"95%\" border=\"1\" cellpadding=\"2\" cellspacing=\"0\">
            <tr>
      ...
      foreach ($this->fields as $key => $value) {
         $output .=  "<tr><td>$key</td><td>".urldecode($value)."&nbsp;</td></tr>";
      }
   ...
   function dump_response() {
      ...
      $output = "<h3>authorizenet_class->dump_response() Output:</h3>";
      $output .=  "<table width=\"95%\" border=\"1\" cellpadding=\"2\" cellspacing=\"0\">
            <tr>
